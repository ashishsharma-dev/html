	...
	$(window).on('load', function () {
		...
		$(".preloader-wrapper").animate({
			...
			setTimeout(function () {
				...
				if ($('.parallax').length) {
					$('.parallax').parallax({
						imageSrc: 'assets/images/photos/parallax_custom.jpg',
						zIndex: '1'
					});
				}
				...
				if ($('.parallax-counter').length) {
					$('.parallax-counter').parallax({
						imageSrc: 'assets/images/photos/parallax-counter_custom.jpg',
						zIndex: '1'
					});
				}
...
document.querySelector(".copyright").innerHTML = `© ${new Date().getFullYear()} GoCoders. All Rights Reserved.`